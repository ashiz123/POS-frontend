            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-200 text-sm">
                ...
                <tr className="hover:bg-slate-50 transition">
                  <td className="px-6 py-4 font-medium">Artisan Espresso</td>
                  <td className="px-6 py-4 text-slate-500">ESP-001</td>
                  <td className="px-6 py-4">Beverages</td>
                  <td className="px-6 py-4 font-semibold">$4.50</td>
                ...
                {/* <!-- Row 2 --> */}
                <tr className="hover:bg-slate-50 transition">
                  <td className="px-6 py-4 font-medium">Organic Avocado</td>
                  <td className="px-6 py-4 text-slate-500">FRU-102</td>
                  <td className="px-6 py-4">Fresh Produce</td>
                  <td className="px-6 py-4 font-semibold">$2.00</td>
